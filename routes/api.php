...
Route::get('v1/public/shops', [PublicController::class, 'getAllPublicShops']); //new structure
// Route::get('v1/public/products', [PublicController::class, 'getProducts']);
Route::get('v1/public/products', [PublicController::class, 'getAllPublicProducts']); //new structure
